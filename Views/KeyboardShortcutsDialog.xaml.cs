    ...
    public partial class KeyboardShortcutsDialog : Window
    {
        public KeyboardShortcutsDialog()
        {
            ...
            var shortcuts = new List<string>
            {
                ...
                "Ctrl + 3 : Switch to Tab 3 (Startup Applications)",
                "Ctrl + 4 : Switch to Tab 4 (Windows Services)",
                "Ctrl + 5 : Switch to Tab 5 (Data Usage)",
                ...
                "Space or Enter (Startup tab) : Toggle startup application (Enable / Disable)",
